...
from graph_src_v2.agents.deepagent_agent.tools import list_deepagent_skills
from graph_src_v2.agents.deepagents_data_analysis_agent.prompts import SYSTEM_PROMPT
...
async def make_graph(config: RunnableConfig, runtime: ServerRuntime) -> Any:
    ...
    return create_deep_agent(
        name="deepagents-data-analysis-demo",
        model=model,
        tools=tools,
